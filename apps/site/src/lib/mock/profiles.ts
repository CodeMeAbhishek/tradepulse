 ...
 */
export const PROFILE_CHECKLIST_FIXTURES: Record<TransactionProfile, DocumentCompletenessItem[]> = {
  ...
  POST_SHIPMENT_DOCUMENT_REVIEW: [
    ...
    },
    {
      ...
      blocker: true,
      reason:
        "Conditionally required for post-shipment profile; missing → DOCUMENT_PACK_INCOMPLETE.",
    },
    {
      documentType: "LETTER_OF_CREDIT",
      state: "NOT_APPLICABLE",
...
export function getChecklistForProfile(profile: TransactionProfile): DocumentCompletenessItem[] {
