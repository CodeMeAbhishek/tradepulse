...
function RegWatchPage() {
  const events = getRegWatchEvents();

  return (
    <main className="mx-auto max-w-6xl px-4 py-8">
      <div className="mb-6">
        <h1 className="text-2xl font-semibold tracking-tight text-ink">RegWatch</h1>
...
export const Route = createFileRoute("/workbench/regwatch")({
  component: RegWatchPage,
});
