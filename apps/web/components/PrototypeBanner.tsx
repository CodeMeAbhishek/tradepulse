    ...
    >
      <p className="mx-auto flex max-w-6xl flex-wrap items-baseline gap-x-3 gap-y-1">
        ...
        <span className="text-amber-200/90">
          Decision support only — not a Customs portal, payment engine, or autonomous approval system.
          No live sanctions, VLEI cryptography, or ICEGATE filing in this prototype.
        </span>
      </p>
    </aside>
  );
