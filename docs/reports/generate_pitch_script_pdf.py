...
def main():
    ...
    blocks = [
        (
            ...
            [
                ...
                "We build <b>documentary trade-compliance decision support</b> for the person who actually owns the exception queue: the <b>Head of Trade Finance Operations at a GIFT City IBU</b> - and the examiners on their desk.",
        ...
        (
            ...
            [
                ...
                "GIFT IFSC is scaling trade finance through IBUs - IFSCA has been enabling trade credit, factoring, forfaiting; IBU trade-finance outstanding is on the order of <b>tens of billions of USD</b>. Volume is rising. Scrutiny is not going away.",
            ],
        ),
        (
        ...
        (
            "[1:35-2:20] Proof (say &quot;working live&quot;)",
            [
    ...
    story.append(
        Paragraph(
            "Word count: spoken body ~430 words -> ~2:50-3:00 at 145 wpm. If fast, pause 2s after &quot;never PASS&quot; and &quot;proof point.&quot;",
            s["caption"],
        )
    )
    ...
    story.append(
        Paragraph(
            "Framing: YC short-pitch clarity; Demo Day 3-min structure; IFSCA/GIFT trade-finance context; Young Builders scoring + Judges' Q&A guidebook.",
            s["caption"],
        )
    )
